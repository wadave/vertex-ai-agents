...
class CocktailAgentExecutor(AgentExecutor):
    ...
    def _init_agent(self) -> None:
        ...
        if self.agent is None:
            ...
            mcp_auth_headers = get_gcp_auth_headers(mcp_url)
            ...
            self.agent = LlmAgent(
                ...
                instruction="""You are a specialized cocktail expert. Your primary function is to utilize the provided tools to retrieve and relay cocktail information in response to user queries. You canhandle all inquiries related to cocktails,
