...
class CocktailAgent:
    ...
    SYSTEM_INSTRUCTION = (
        """You are a specialized cocktail assistant. Your primary function is to utilize the provided tools to retrieve and relay cocktail information in response to user queries. You can handle all inquiries related to cocktails,
